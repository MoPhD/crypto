...
1.	It takes command line arguments to --encrypt or --decrypt (use argparse)
2.	It runs from command line: python <ceasercipher.py> [args]
3.	It runs with Python 3.x to encrypt and decrypt a string from the command line.
